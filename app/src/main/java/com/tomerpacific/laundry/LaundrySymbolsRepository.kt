...
class LaundrySymbolsRepository {
    ...
    fun createDryingSymbols(context: Context): List<LaundrySymbol> {
        return listOf(
            ...
            LaundrySymbol(
                id = "dry-cleaning-petroleum-solvent-only",
